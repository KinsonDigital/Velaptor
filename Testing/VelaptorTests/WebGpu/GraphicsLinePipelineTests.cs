...
public class GraphicsLinePipelineTests
{
    ...
    public void Ctor_WithNullGraphicsDeviceParam_ThrowsException()
    {
        ...
        // Assert
        act.ShouldThrow<ArgumentNullException>().Message.ShouldBe("Value cannot be null. (Parameter 'graphicsDevice')");
    }
    ...
    {
        // Arrange & Act
        var act = () => { _ = new GraphicsLinePipeline(this.mockDevice, null, this.mockShader); };
    ...
    {
        // Arrange & Act
        var act = () => { _ = new GraphicsLinePipeline(this.mockDevice, this.mockSurface, null); };
    ...
    private GraphicsLinePipeline CreateSystemUnderTest() => new (this.mockDevice, this.mockSurface, this.mockShader);
}
