...
public sealed class SafeVertexBufferHandleTests
{
    ...
    public void Ctor_WithNullWgpuParam_ThrowsException()
    {
        ...
        // Act
        var act = () => new SafeVertexBufferHandle(null, deviceHandle, ref descriptor);
    ...
    public void Ctor_WithNullDeviceHandleParam_ThrowsException()
    {
        ...
        // Act
        var act = () => new SafeVertexBufferHandle(this.mockWgpu, null, ref descriptor);
    ...
    public void Ctor_WithDeviceAndDescriptor_CallsDeviceCreateBuffer()
    {
        ...
        // Act
        var sut = new SafeVertexBufferHandle(this.mockWgpu, deviceHandle, ref descriptor);
