// <copyright file="SafeBindGroupHandleTests.cs" company="KinsonDigital">
...
/// <summary>
/// Tests the <see cref="SafeBindGroupHandle"/> class.
/// </summary>
public sealed class SafeBindGroupHandleTests
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SafeBindGroupHandleTests"/> class.
    /// </summary>
    public SafeBindGroupHandleTests() => this.mockWgpu = Substitute.For<IWgpuInvoker>();
    ...
    {
        // Arrange & Act
        var act = () => new SafeBindGroupHandle(null, this.validHandle);
    ...
    {
        // Act
        var sut = new SafeBindGroupHandle(this.mockWgpu, this.invalidHandle);
    ...
    public void Dispose_WithValidHandle_ReleasesHandle()
    {
        ...
        // Assert
        this.mockWgpu.Received(1).BindGroupRelease(this.validHandle);
    }
    ...
    public void Dispose_WithInvalidHandle_DoesNotReleaseHandle()
    {
        ...
        // Assert
        this.mockWgpu.DidNotReceive().BindGroupRelease(Arg.Any<nint>());
    }
    #endregion

    /// <summary>
    /// Creates a new <see cref="SafeBindGroupHandle"/> for testing.
    /// </summary>
    /// <returns>The handle to test.</returns>
    private SafeBindGroupHandle CreateHandle() => new (this.mockWgpu, this.validHandle);
}
