// <copyright file="SafeShaderModuleHandleTests.cs" company="KinsonDigital">
...
/// <summary>
/// Tests the <see cref="SafeShaderModuleHandle"/> class.
/// </summary>
public sealed class SafeShaderModuleHandleTests
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SafeShaderModuleHandleTests"/> class.
    /// </summary>
    public SafeShaderModuleHandleTests() => this.mockWgpu = Substitute.For<IWgpuInvoker>();
    ...
    {
        // Arrange & Act
        var act = () => new SafeShaderModuleHandle(null, this.validHandle);
    ...
    {
        // Act
        var sut = new SafeShaderModuleHandle(this.mockWgpu, this.invalidHandle);
    ...
    public void Dispose_WithValidHandle_ReleasesHandle()
    {
        ...
        // Assert
        this.mockWgpu.Received(1).ShaderModuleRelease(this.validHandle);
    }
    ...
    public void Dispose_WithInvalidHandle_DoesNotReleaseHandle()
    {
        ...
        // Assert
        this.mockWgpu.DidNotReceive().ShaderModuleRelease(Arg.Any<nint>());
    }
    #endregion

    /// <summary>
    /// Creates a new <see cref="SafeShaderModuleHandle"/> for testing.
    /// </summary>
    /// <returns>The handle to test.</returns>
    private SafeShaderModuleHandle CreateHandle() => new (this.mockWgpu, this.validHandle);
}
