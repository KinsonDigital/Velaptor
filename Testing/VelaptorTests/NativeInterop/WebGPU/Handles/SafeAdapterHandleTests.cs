// <copyright file="SafeAdapterHandleTests.cs" company="KinsonDigital">
...
/// <summary>
/// Tests the <see cref="SafeAdapterHandle"/> class.
/// </summary>
public sealed class SafeAdapterHandleTests
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SafeAdapterHandleTests"/> class.
    /// </summary>
    public SafeAdapterHandleTests() => this.mockWgpu = Substitute.For<IWgpuInvoker>();
    ...
    {
        // Arrange & Act
        var act = () => new SafeAdapterHandle(null, this.validHandle);
    ...
    {
        // Act
        var sut = new SafeAdapterHandle(this.mockWgpu, this.invalidHandle);
    ...
    public void Dispose_WithValidHandle_ReleasesHandle()
    {
        ...
        // Assert
        this.mockWgpu.Received(1).AdapterRelease(this.validHandle);
    }
    ...
    public void Dispose_WithInvalidHandle_DoesNotReleaseHandle()
    {
        ...
        // Assert
        this.mockWgpu.DidNotReceive().AdapterRelease(Arg.Any<nint>());
    }
    #endregion

    /// <summary>
    /// Creates a new <see cref="SafeAdapterHandle"/> for testing.
    /// </summary>
    /// <returns>The handle to test.</returns>
    private SafeAdapterHandle CreateHandle() => new (this.mockWgpu, this.validHandle);
}
