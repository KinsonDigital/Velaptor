...
public class RenderMediatorTests
{
    ...
    private readonly Mock<IComparer<RenderItem<RectBatchItem>>> mockRectComparer;
    ...
    private readonly Mock<IRenderBatchReactable<RectBatchItem>> mockRectRenderBatchReactable;
    ...
    private readonly Mock<IBatchPullReactable<RectBatchItem>> mockRectPullReactable;
    ...
    public RenderMediatorTests()
    {
        ...
        this.mockRectPullReactable = new Mock<IBatchPullReactable<RectBatchItem>>();
        ...
        this.mockRectRenderBatchReactable = new Mock<IRenderBatchReactable<RectBatchItem>>();
        ...
        this.mockRectComparer = new Mock<IComparer<RenderItem<RectBatchItem>>>();
    ...
    public void PushReactable_WithBatchEndNotification_CoordinatesRenderCalls()
    {
        ...
        this.mockRectPullReactable.Setup(m => m.Pull(It.IsAny<Guid>()))
            .Returns<Guid>(_ => new Memory<RenderItem<RectBatchItem>>(rectItems));
        ...
        this.mockRectRenderBatchReactable
            .Setup(m => m.Push(It.Ref<Memory<RenderItem<RectBatchItem>>>.IsAny, It.IsAny<Guid>()))
        ...
        void AssertRectItems(in Memory<RenderItem<RectBatchItem>> data, Guid eventId)
        {
