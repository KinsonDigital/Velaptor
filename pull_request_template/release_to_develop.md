This <span style="color:ghostwhite;font-weight:bold">PR</span> merges everything related to release v<span style="color:darkorange;font-weight:bold">[version]</span> into the develop branch.
